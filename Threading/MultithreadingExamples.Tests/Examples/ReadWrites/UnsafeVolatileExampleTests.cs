...
{
    [TestFixture]
    public class UnsafeVolatileExampleTests : ExampleTestBase<UnsafeVolatileExample>
    {
        [Ignore]
        [Test(Description = @"This test can succeed on some less core machines.")]
        public void VolatileIncrementFailsSometimesBecauseTheAddOperationIsNotAtomic()
        {
            // Arrange
